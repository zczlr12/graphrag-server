...
**References should be listed with a single record ID per citation**, with each citation containing only one record ID. For example, [Data:Reports(38)][Data:Reports(55)], instead of [Data:Reports(38, 55)].
